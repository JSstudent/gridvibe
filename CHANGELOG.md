...
- Added read-only Git awareness to Local Repo file explorer panes, including branch/dirty summaries, per-entry status badges, directory dirty markers, and bounded internal old/new diff previews with added/removed line highlighting.
