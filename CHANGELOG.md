...
- Improved Linux pywebview startup in VMs by requesting the Qt backend directly and avoiding QtWebEngine GPU/Vulkan paths when launching the native window.
